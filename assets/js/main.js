(function () {
  ...
  const contactSubmit = async (data) => {
    return new Promise(async (resolve, reject) => {
      console.log(data);
      await fetch("https://apiservices.geekstudios.tech/unbug/contact/add", {
        method: "POST",
  ...
  $("#submit-form").submit(async (e) => {
    e.preventDefault();
    $(".alert-box").html(
      '<div class="alert-unbug sending">Please wait, sending your message to unBug. &nbsp;<i class="bx bx-loader-alt load-it"></i></div>'
    );
    ...
    let data = await contactSubmit(obj);
    if (data.response_code == 200) {
      $(".alert-box").html(
        '<div class="alert-unbug success">Success! your message has been sent to unBug, we will get in touch with you soon. &nbsp;<i class="bx bx-badge-check zoom-it"></i></div>'
      );
      ...
      $(".alert-box").html(
        '<div class="alert-unbug failed">Aw snap! message sending failed. Try after sometime. &nbsp;<i class="bx bx-upside-down load-it-less"></i></div>'
      );
      setTimeout(function () {
        $(".alert-box").html("");
      }, 4500);
